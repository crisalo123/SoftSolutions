...
import  ecommers  from '@/feature/auth/assets/ecomers_Blue.png'
  ...
  return (
    <div className=' h-screen bg-primary-50 '>
      <Wrapper className='md:flex h-full items-center justify-center pt-14 md:pt-0 pr-2 md:pr-0 pl-2 md:pl-0'>
        <div className='flex md:h-[550px] h-[520px]  md:max-w-[1280px] items-center justify-center rounded-[32px] border-2 bg-quaternary p-2 2xl:h-[800px]'>
          <div className='flex h-full md:max-w-[652px]  flex-col items-center justify-center gap-7 rounded-[32px] md:px-7 2xl:px-32'>
            <h1 className='md:w-[394px] text-center text-4xl font-black text-primary-600 2xl:text-5xl'>
              Inicio de sesión
            </h1>
          ...
          <div className='hidden relative md:flex h-full flex-col items-center justify-center gap-16 rounded-[32px] bg-primary-600 p-10'>
            <img
              src={logo}
              alt='Logo de genesis'
              className='absolute right-0 2xl:top-0 mr-10  2xl:mt-10 h-10 top-6 '
            />
             <span className='absolute 2xl:top-14 top-8 font-bold text-white tracking-wider'>TrueQue.COM</span>
            <img
              src={ecommers}
              alt='ilustracion de login'
              className='!mt-16 h-80 2xl:h-auto 2xl:min-w-96'
            />
